...
public final class DateUtil {
     ...
     * yyyyMMdd字符串
     */
    public static final String DEFAULT_FORMAT_CURRENT_TIME = "yyyyMMdd";

    /**
     * yyyyMMdd字符串
     */
    public static final String DEFAULT_DATE = "MM月dd日";
     ...
     * yyyyMMdd格式
     */
    public static final ThreadLocal<SimpleDateFormat> defaultCurrentTimeFormat = new ThreadLocal<SimpleDateFormat>() {

        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat(DEFAULT_FORMAT_CURRENT_TIME);
        }
     ...
     * MM月dd日格式
     */
    public static final ThreadLocal<SimpleDateFormat> defaultCurrentDate = new ThreadLocal<SimpleDateFormat>() {
     ...
     * @return yyyy-MM-dd
     */
    public static String getCurrentDateTimeFromMillis(long timeInMillis) {
        return getCurrentDateFormat(new Date(timeInMillis));
    }
    ...
    /**
     * 将date转成yyyyMMdd字符串<br>
     *
     * @param date Date对象
     * @return yyyy-MM-dd
     */
    public static String getCurrentDateFormat(Date date) {
        return dateSimpleFormat(date, defaultCurrentTimeFormat.get());
    }
    ...
    public static String getCurrentDate(Date date) {
        return dateSimpleFormat(date, defaultCurrentDate.get());
    }
